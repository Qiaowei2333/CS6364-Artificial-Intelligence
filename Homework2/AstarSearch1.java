...
//		}
		...
		AstarSearch1 a = new AstarSearch1();	
		System.out.println("w=0.25 ");
		int ex = 1+a.AstarFind(0, City[1], City[12], City, Adj0, (float) 0.25, 0, Path);//ex is the number of expanded nodes, +1 is because we have to include the first node
